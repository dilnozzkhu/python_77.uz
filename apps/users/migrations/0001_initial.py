    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sellers', to='common.address', verbose_name='address')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sellers', to='store.category', verbose_name='category')),
